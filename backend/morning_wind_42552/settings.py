"""
Django settings for morning_wind_42552 project.
...
ROOT_URLCONF = 'morning_wind_42552.urls'
...
WSGI_APPLICATION = 'morning_wind_42552.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_wind_42552 API",
    "DESCRIPTION": "API documentation for morning_wind_42552 App",
    "VERSION": "v1",
}
